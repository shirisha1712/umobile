        ...
        <div className="flex w-[169px] items-start gap-[7.82px] absolute top-0 left-0">
          <div className="relative w-[168.9px] h-[40.44px]">
            <Badge className="relative w-[169px] h-10 bg-[#f17228] rounded-[7.82px] p-0 hover:bg-[#f17228] hover:text-themewhite">
              <img className="w-10 h-10" alt="Talabat logo" src="/img_talabat_logo_2.png" />
        ...
        <div className="min-h-[110px] relative w-full">
          <div className="relative w-[353px] h-[92px] left-[18px]">
            ...
            <div className="absolute w-[215px] h-6 top-[69px] left-0">
              ...
              <div className="absolute top-2 left-[118px] font-medium text-gray-500 text-base tracking-[0] leading-[normal]">
                      30-45 mins.
                    </div>
