...
export const Frame2Subsection = (): JSX.Element => {
  ...
  return (
    <Card 
      className="relative w-full max-w-[383px] rounded-[15px_15px_16.54px_16.54px] shadow-[0px_4.76px_4.76px_#0000004c] overflow-hidden cursor-pointer hover:shadow-lg transition-shadow"
      onClick={handleCardClick}
    >
      <div className="rounded-[15px_15px_0px_0px] [background:url(..//frame-45-3.png)_50%_50%_/_cover,linear-gradient(0deg,rgba(245,245,245,1)_0%,rgba(245,245,245,1)_100%)] relative w-full h-[193px] overflow-hidden">
        <div className="flex items-start gap-[7.82px] absolute top-0 left-0">
          <div className="relative w-[168.99px] h-[40.46px]">
            <Badge className="relative w-[169px] h-10 bg-[#f17228] rounded-[7.82px] p-0 hover:bg-[#f17228] hover:text-themewhite">
              <img className="w-[41px] h-10" alt="Talabat logo" src="/img_talabat_logo_2.png" />
